...
namespace AT86RF215 {
    ...
    struct RXConfig {
        ...
        static RXConfig DefaultRXConfig() {
            return {
                ...
                /// RF_AGCS
                .automaticGainTarget09 = AutomaticGainTarget::DB21,
    ...
    struct BasebandCoreConfig {
        ...
        /// RX length
        uint16_t fixed_rx_length;

        // preable
        uint8_t preambleLength;


        static BasebandCoreConfig DefaultBasebandCoreConfig(uint32_t synchword, uint16_t fixed_rx_length, uint8_t preamble_length) {
            return {
                ...
                .receiver_override_09 = Receiver_Override::override_disabled,
                .receiver_preamble_timeout_09 = Receiver_Preamble_Timeout::timeout_enabled,
                ...
                .prdt_09 = Preamble_Detection_Threshold::medium,
                /// BBCn_FSkC4
                .sfdQuantization_09 = SFD_Quantization::SOFT_DECISION,
                .sfd32_09 = SFD_32::SINGLE_32BIT_SFD,
                .rawModeReversalBit_09 = Raw_Mode_Reversal_Bit::MSB_FIRST,
                // FEC enabled: CODED IEEE MODE
                .csfd1_09 = CSFD1::UNCODED_RAW_MODE,
                .csfd0_09 = CSFD0::UNCODED_RAW_MODE,
                /// BBCn_FSKPHRTX
                ...
                /// sync word
                .sfd0 = static_cast<uint16_t>(etl::reverse_bits(synchword)),
                .sfd1 = static_cast<uint16_t>(etl::reverse_bits(synchword) >> 16),

                .fixed_rx_length = fixed_rx_length,
